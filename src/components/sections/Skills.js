          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list">
              ...
              <ul>
                ...
                {/* <li className="border-line-h">
                  <div className="name">Flutterflow</div>
                  <div className="progress">
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list">
              ...
              <ul>
                ...
                <li className="border-line-h">
                  <div className="name">Afrikaans</div>
                  <div className="progress">
                    <div className="percentage" style={{ width: "85%" }} />
                  </div>
                </li>
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list circles">
              ...
              <ul>
                ...
                <li>
                  <div className="name">Xamarin Forms</div>
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list list">
              <div className="skill-title border-line-h">
                ...
                <div className="name">Softskills</div>
              </div>
              <ul>
                <li>
                  <div className="name">General Management</div>
                </li>
                <li>
                  <div className="name">IT Lead</div>
                </li>
                <li>
                  <div className="name">Team Lead</div>
                </li>
                <li>
                  <div className="name">Project Lead</div>
                </li>
                <li>
                  <div className="name">Mentoring/Coaching</div>
                </li>
                <li>
                  <div className="name">Event Management</div>
                </li>
                <li>
                  <div className="name">Performance Management</div>
                </li>
                {/* <li>
